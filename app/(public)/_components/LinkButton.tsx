...
const LinkButton = ({
  ...
  return (
    <div className='relative hover:scale-110 transition-all ease-in-out'>
      ...
      <Link
        href={link}
        className='text-sm xl:text-lg text-primary-foreground uppercase tracking-wider lg:tracking-widest font-medium bg-primary rounded-full w-64 h-10 md:w-82 md:h-13 lg:w-70 lg:h-11 text-center p-6
