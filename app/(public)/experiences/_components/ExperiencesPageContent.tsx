...
type ExperiencesPageContentProps = {
  pastExperiences: ExperienceItem[];
  upcomingExperiences: ExperienceItem[];
};

const ExperiencesPageContent = ({
  pastExperiences,
  upcomingExperiences,
}: ExperiencesPageContentProps) => {
  console.log("past experience[0] date:", pastExperiences[0].date);
    ...
    <main>
      ...
      {/* {error.length > 0 && (
        <div className='p-8 text-center'>
          <p className='text-4xl font-bold mb-4'>Oh no! An error occurred</p>
          <p className='text-[1rem] font-light'>{error}</p>
        </div>
      )} */}
