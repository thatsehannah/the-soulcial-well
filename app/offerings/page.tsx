    ...
    <main className='xl:p-32 pt-38 pb-12 px-7'>
      <section className='grid lg:grid-cols-2 grid-cols-1 gap-2 w-full'>
        <div className='flex flex-col justify-center items-center p-8'>
          <p className='relative text-5xl lg:text-6xl text-center mb-12 text-main-foreground after:bg-[url("/assets/underline-stroke-brown.svg")] after:absolute after:left-0 lg:after:-bottom-9 after:-bottom-9 after:w-full after:h-13 after:bg-no-repeat after:bg-contain after:bg-center'>
            Offerings
          </p>
